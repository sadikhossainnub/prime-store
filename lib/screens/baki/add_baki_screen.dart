...
class AddBakiScreen extends StatefulWidget {
  const AddBakiScreen({super.key});

  @override
  State<AddBakiScreen> createState() => _AddBakiScreenState();
}

class _AddBakiScreenState extends State<AddBakiScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('বাকি যোগ করুন')),
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              const Text('বিবরণ (অপশনাল)', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              const SizedBox(height: 10),
              GlassCard(
                padding: EdgeInsets.zero,
                child: TextField(
  ...
  void _saveBaki() async {
    ...
    await context.read<TransactionProvider>().addBaki(
